    ...
    public partial class TestWizSigCapt : Form
    {
            ...
            if (success)
            {
                ...
                switch (WizCtl.PadWidth)
                {
                    ...
                    case 640: Pad = new tPad("STU-500", 300, 360, 390, 16, 22, 32, 110); // 640 x 800
                        break;
                    case 800: Pad = new tPad("STU-520, 530 or 540", 300, 360, 390, 16, 22, 32, 110); // 800 x 480
                        break;
        ...
        private void scriptCompleted()
        {
            ...
            if (sigObj.IsCaptured)
            {
                ...
                sigObj.RenderBitmap(filename, 300, 225, "image/png", 0.5f, 0xff0000, 0xffffff, -1.0f, -1.0f, RBFlags.RenderOutputFilename | RBFlags.RenderColor32BPP | RBFlags.RenderEncodeData);
                using (FileStream fs = new FileStream(filename, FileMode.Open, FileAccess.Read))
                {
                    print("Loading image from file stream");
