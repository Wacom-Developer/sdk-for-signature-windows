...
class CaptureImageRelative {
  ...
  private static void print(String s) {
    ...
    String filename = "sig-relative.png";
    if( args.length > 0 )
      filename = args[0];
    try
      { 
        ...
        if(rc == 0) {
          ...
          int flags = SigObj.renderRelative | SigObj.outputFilename | SigObj.color32BPP | SigObj.encodeData;
          sig.renderBitmap(filename, -160, -160, "image/png", 0.5f, 0xff0000, 0xffffff, 0.0f, 0.0f, flags );
